...
function Button({ children, onClick, ...props }) {
  const buttonClasses = classNames(
    ...
    {
      "hover:after:bg-pure-white/50 hover:after:rounded-xl hover:after:absolute hover:after:top-0 hover:after:left-0 hover:after:w-full hover:after:h-full": true,
    }
  );
